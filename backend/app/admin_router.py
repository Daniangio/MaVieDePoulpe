...
async def admin_create_level(
    ...
    counter_attack_min_size_index: int = Form(default=1),
    ...
    size_requirements_json: str | None = Form(default=None),
    ...
    try:
        return save_level(
            ...
            counter_attack_min_size_index=counter_attack_min_size_index,
            ...
            size_requirements=_json_form_list(size_requirements_json, "size_requirements_json") if size_requirements_json is not None else None,
